# Connecting ORMCP to excel-poc-service

Generated by orm_skyway.py

**Object model:** Excel workbook exposed as an object model (Excel + CData proof of concept)
...
- The `excel-poc-service` Gilhari microservice must be running:
  ```
...
export MCP_SERVER_NAME="excel-poc-service-ormcp"
export GILHARI_NAME="excel-poc-service"
export GILHARI_IMAGE="excel-poc-service:1.0"
export GILHARI_PORT="80"
export READONLY_MODE="True"

# Windows (Command Prompt)
set GILHARI_BASE_URL=http://localhost:80/gilhari/v1/
set MCP_SERVER_NAME=excel-poc-service-ormcp
set GILHARI_NAME=excel-poc-service
set GILHARI_IMAGE=excel-poc-service:1.0
set GILHARI_PORT=80
...
- *"Show me all Customers objects"*
- *"How many Customers objects are there?"*
...
| `MCP_SERVER_NAME` | `excel-poc-service-ormcp` | Name shown in AI client tool lists |
| `GILHARI_NAME` | `excel-poc-service` | Container name for auto-start |
| `GILHARI_IMAGE` | `excel-poc-service:1.0` | Docker image for auto-start |
